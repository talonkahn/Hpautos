    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-14">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-xl mx-auto mb-8">Browse RC-verified car stands and dealerships on HP-Autos. Every store is admin-approved.</p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-slate-500 mb-6">Be the first dealership on HP-Autos Nigeria.</p>
