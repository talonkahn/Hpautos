...
const BENEFITS = [
  'Request admin to list your cars on HP-Autos',
...
export default function BecomeSeller() {
  ...
  if (!isAuthenticated) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <Card className="max-w-md w-full p-8 text-center">
        ...
        <p className="text-slate-500 mb-6">Sign up with your email to become a seller on HP-Autos.</p>
  ...
  if (profile?.seller_active) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <Card className="max-w-md w-full p-8 text-center">
        ...
        <a href={`https://wa.me/${ADMIN_WHATSAPP}?text=Hi%2C%20I'm%20an%20active%20seller%20on%20HP-Autos%20(${user?.email}).%20I'd%20like%20to%20list%20a%20car.`} target="_blank" rel="noopener noreferrer">
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-10 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <Badge className="mb-6 bg-amber-500/20 text-amber-400 border-amber-500/30 px-4 py-2">Seller Subscription</Badge>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 px-2">Sell Your Car on HP-Autos</h1>
          <p className="text-base sm:text-xl text-slate-300 max-w-2xl mx-auto px-2">Pay once. Admin lists your car for you — maximum trust, maximum buyers.</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="mt-4 bg-slate-100 rounded-xl p-4">
            ...
            <a href={`https://wa.me/${ADMIN_WHATSAPP}?text=Hi%2C%20I%20want%20to%20become%20a%20seller%20on%20HP-Autos.%20Please%20send%20payment%20details.`} target="_blank" rel="noopener noreferrer" className="block mt-2">
