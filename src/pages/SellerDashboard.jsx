      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
          ...
          <>
            {expiringSoon && (
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-center gap-3">
                ...
                <a href={`https://wa.me/${ADMIN_WHATSAPP}?text=Hi%2C%20I%20need%20to%20renew%20my%20seller%20subscription%20on%20HP-Autos.%20Email%3A%20${user?.email}`} target="_blank" rel="noopener noreferrer">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5">
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <a href={`https://wa.me/${ADMIN_WHATSAPP}?text=Hi%2C%20I%20am%20an%20active%20seller%20on%20HP-Autos%20(${user?.email}).%20I%20would%20like%20to%20submit%20a%20car%20for%20listing.`} target="_blank" rel="noopener noreferrer">
        ...
        <div className="bg-slate-800 text-white rounded-xl p-5 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm">Register your store for free — get an RC-verified store page on HP-Autos.</p>
            </div>
          </div>
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-dashed border-slate-200">
              ...
              {isSeller
                ? <><p className="text-slate-500 text-sm mb-4">Submit your car details to admin on WhatsApp to get listed.</p>
                    <a href={`https://wa.me/${ADMIN_WHATSAPP}?text=Hi%2C%20I%20am%20a%20seller%20on%20HP-Autos%20(${user?.email}).%20I%20would%20like%20to%20list%20a%20car.`} target="_blank" rel="noopener noreferrer">
                ...
                : <><p className="text-slate-500 text-sm mb-4">Become a seller to get your car listed on HP-Autos.</p>
        ...
        <Card className="bg-slate-50 border-slate-200">
          <CardContent className="p-6">
            <h3 className="font-bold text-slate-900 mb-4">How Selling on HP-Autos Works</h3>
