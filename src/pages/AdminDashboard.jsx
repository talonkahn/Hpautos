  ...
  const handleAdminList = async () => {
    ...
    try {
      ...
      const carData = {
        ...
        seller_name: listForm.seller_name || 'H-Autos Admin',
      ...
      setListForm({ make:'',model:'',year:new Date().getFullYear(),price:'',state:'',city:'',condition:'nigerian_used',description:'',images:[],seller_name:'H-Autos Admin',seller_phone:'',seller_whatsapp:'+2348146730044',fuel_type:'petrol',transmission:'automatic',mileage:'',title:'',store_id:'',country:'NG' });
      loadAll();
    } catch (e) {
