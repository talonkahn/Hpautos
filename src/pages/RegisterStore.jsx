...
const BENEFITS = [
  'Dedicated store page inside HP-Autos',
...
export default function RegisterStore() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white py-10 sm:py-14">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <Badge className="mb-6 bg-blue-500/20 text-blue-400 border-blue-500/30 px-4 py-2">🏪 Car Stands & Dealerships</Badge>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 px-2">Register Your Car Store</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">Get your dealership or car stand on HP-Autos. RC-verified stores build investor confidence and buyer trust.</p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid md:grid-cols-5 gap-8">
        <div className="md:col-span-2">
          ...
          <div className="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-4">
            ...
            <p className="text-sm text-blue-700">HP-Autos is actively building an investor-grade marketplace. RC-verified stores are featured in our pitch deck and investor reports.</p>
          </div>
